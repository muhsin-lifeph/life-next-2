            ...
            <div className="z-10  mx-auto ">
                <div className=" border border-muted lg:py-8 sm:py-5 py-4">
                    <div className="max-w-[1450px] mx-auto px-[10px] flex justify-around md:text-3xl sm:text-2xl text-xl ">
                        ...
                        <div >
                            <div className="text-center font-bold ">{t.footer.top_part.n25M}</div>
                            <div className=" text-center  text-gray-600 sm:text-sm text-xs">{t.footer.top_part.orders_delivered}</div>
                        </div>
                        <div >
                            <div className="text-center  font-bold ">{t.footer.top_part.n375}</div>
                        ...
                        <div className="md:flex md:justify-between ">
                            <div className="mb-6 md:mb-0 space-y-5 block  justify-between md:justify-normal mr-5 ">
                                <div>
                                    ...
                                    <div dangerouslySetInnerHTML={{ __html: t.footer.bottom_part.life_address }} className="text-gray-600  text-sm" />
                                </div>
                            ...
                            <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 sm:gap-6 lg:grid-cols-5 text-xs md:text-sm md:grid-cols-3 ">
                                <div>
                                    ...
                                    <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/about" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.know_us.about_life_store}</Link>
                                        </li>
                                        <li >
                                ...
                                <div>
                                    <h2 className="mb-3 text-gray-900   font-bold text-base">{t.footer.bottom_part.our_policies.title}</h2>
                                    <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/refund-policy" className="hover:text-blue-500 text-gray-500 underline-tra ">{t.footer.bottom_part.our_policies.refund_policy}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/shipping-terms" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.our_policies.ship_terms}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/privacy-policy" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.our_policies.pandp}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/terms-and-conditions" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.our_policies.tandc}</Link>
                                        </li>

                                    </ul>
                                </div>
                                <div>
                                    <h2 className="mb-3 text-gray-900  font-bold text-base">{t.footer.bottom_part.shop_by_cat.title}</h2>
                                    <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                                        <li>
                                ...
                                <div>
                                    <h2 className="mb-3 text-gray-900  font-bold text-base">{t.footer.bottom_part.useful_links.title}</h2>
                                    <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/brands" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.useful_links.browse_by_brands}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/sitemap" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.useful_links.site_map}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/offers" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.useful_links.offers_coupons}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/appointments" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.useful_links.appointments}</Link>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    <h2 className="mb-2 text-gray-900  font-bold text-base">{t.footer.bottom_part.my_account.title}</h2>
                                    <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/dashboard" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.my_account.loginorsignup}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/cart" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.my_account.view_cart}</Link>
                                        </li>
                                        <li >
                                            <Link href="https://www.lifepharmacy.com/wishlist" className="hover:text-blue-500 text-gray-500 underline-tra">{t.footer.bottom_part.my_account.my_wish_list}</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
