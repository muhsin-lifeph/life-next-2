            ...
            {!isSearchPage ?
                <div className="flex justify-between py-3">
                    ...
                    <div className=" items-center md:flex hidden">
                        ...
                        <div className="ml-5">
                            <input type="radio" checked={!isRowView} id="grid-view" name="col-type" className="hidden peer" />
                        ...
                        <input type="radio" checked={isRowView} id="list-view" name="col-type" className="hidden peer" />
